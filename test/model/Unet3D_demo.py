...
class UNet(Module):
    ...
    def forward(self, x):
        ...
        x1 = self.conv_blk1(x) # [1 64 128 128 32]

        x_low1 = self.pool1(x1) # [1 64 64 64 16]
        x2 = self.conv_blk2(x_low1) # [1 256 64 64 16]

        x_low2 = self.pool2(x2) # [1 256 32 32 8]
        x3 = self.conv_blk3(x_low2) # [1 512 32 32 8]

        x_low3 = self.pool3(x3) # [1 256 16 16 4]
        x4 = self.conv_blk4(x_low3) # [1 1024 16 16 4]

        x_low4 = self.pool4(x4) # [1 512 8 8 2]
        base = self.conv_blk5(x_low4) # [1 1024 8 8 2]
        # print()
        print("x1 : ", x1.shape)
