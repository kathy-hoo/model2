...
if __name__ == "__main__":
    ...
    checkpoint_path = '/home/bai_gairui/seg_3d/model2/segmentation_3d/logs/resoulution-128-train-cp_Vnet_udc/version_0/checkpoints/epoch=499-step=112500.ckpt'
    if 1 == 1:
