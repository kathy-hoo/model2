...
checkpoint_path = '/home/bai_gairui/seg_3d/model2/segmentation_3d/logs/resoulution-128-train-Ours/version_3/checkpoints/epoch=3784-step=348220.ckpt'
...
output1 = "Ours"
for (folder_name, folder_indx) in zip(folder_name_list, folder_name_list_ind):
    print(folder_name)
