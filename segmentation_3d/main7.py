...
if __name__ == "__main__":
    ...
    # checkpoint_path = '/home/bai_gairui/seg_3d/model2/segmentation_3d/logs/resoulution-128-train-cp_VTUnet/version_4/checkpoints/epoch=864-step=318320.ckpt'
    if 1 == 1:
        ...
        trainer = pl.Trainer(accelerator="gpu",  devices=[2],  precision=16, max_epochs=500, logger=logger)
        model = Wapper("")
        # model = Wapper("")
        if mode == "train":
