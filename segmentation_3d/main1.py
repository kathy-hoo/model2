...
class Wapper(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        schedular = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=150)
...
if __name__ == "__main__":
    ...
    trainer = pl.Trainer(accelerator="gpu",  devices=[1, 2],  precision=32, max_epochs=150, logger=logger, log_every_n_steps=1)
    model = Wapper(info="permute_mlp中修改s的位置, 背景不做dice, batch_size = 4 resolution = 128")
