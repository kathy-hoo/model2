...
if __name__ == "__main__":
    ...
    checkpoint_path = '/home/bai_gairui/seg_3d/model2/segmentation_3d/logs/resoulution-128-train-cp_Unetr_udc/version_0/checkpoints/epoch=499-step=112500.ckpt'
    if 1 == 1:
        ...
        model = Wapper("") 
        x = torch.rand((1, 1, 128, 128, 128), device=model.device)
        y = model(x)
        print(y.shape)
