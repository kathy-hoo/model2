...
if __name__ == "__main__":
    ...
    checkpoint_path = '/home/bai_gairui/seg_3d/model2/segmentation_3d/logs/resoulution-128-train-cp_VTUnet_udc/version_3/checkpoints/epoch=499-step=112500.ckpt'
    if 1 == 1:
        ...
        trainer = pl.Trainer(accelerator="gpu",  devices=[6],  precision=16, max_epochs=3000, logger=logger)
